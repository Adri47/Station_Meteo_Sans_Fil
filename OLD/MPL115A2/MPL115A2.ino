...
void loop() {
  ...
  Pressure = conversionPression(Pcomp);
  Temperature = calculTemperature(Tab_press_temp[1]);
  ...
  Serial.print("Padc :");
  Serial.println(Tab_press_temp[0], DEC);
  Serial.print("Tadc :");
  Serial.println(Tab_press_temp[1], DEC);
  Serial.println();
//  Serial.print(Pcomp, DEC);
//  float Pression = conversionPression(Pcomp);
//  Serial.print("  ");
//  Serial.println(Pression, DEC);
